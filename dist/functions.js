...
exports.BottomSheetShow = BottomSheetShow;
exports.scrollBottomSheet = scrollBottomSheet;
function BottomSheetShow(bottomSheetElement, overlayBlur) {
  ...
  setTimeout(() => {
    ...
    bottomSheetElement.current.style.webkitBackdropFilter = `blur(${overlayBlur != undefined ? overlayBlur : 2}px)`;
    bottomSheetElement.current.style.backdropFilter = `blur(${overlayBlur != undefined ? overlayBlur : 2}px)`;
